...
import { QueryRule, Schema, OPERATOR_LABELS, OPERATORS_BY_TYPE } from '@/types/query';
...
export function ConditionRule({ rule, schema, hasError, errorMessage, onRemove }: Props) {
    ...
    <div ref={setNodeRef} style={style}>
      ...
      >
        ...
        <div style={{
          ...
          height: '20px',
          borderRadius: '50%',
          background: hasError ? 'rgba(255,77,109,0.15)' : 'var(--amber-trace)',
        ...
        {!needsNoValue && (
          <div style={{ display: 'flex', gap: '6px', alignItems: 'center', flex: 1, minWidth: 0 }}>
            ...
            {needsTwoValues && (
              <>
                <span style={{ color: 'var(--text-muted)', fontFamily: 'var(--font-mono)', fontSize: '11px', flexShrink: 0 }}>
                  ↔
                </span>
                <ValueInput
